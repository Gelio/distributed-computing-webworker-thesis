...
\chapter{Podsumowanie}
    ...
    \section{Wnioski z projektu}
        ...
        \subsection{Tworzenie interfejsu użytkownika jest czasochłonne}
            ...
            Przy interfejsie użytkownika warto wziąć pod uwagę obsługę błędów. Często jest ona pomijana, a jest jedną z kluczowych praktyk poprawiających zadowolenie użytkownika z korzystania z systemu (ang. \textit{User Experience}).
