...
\chapter{Podsumowanie}
    \section{Własności rozwiązania}
        Poniższa sekcja opisuje kwestie wydajności, wieloplatformości, prostoty obsługi oraz bezpieczeństwa utworzonego systemu.
        ...
        \subsection{Wydajność}
            ...
            Wykonane testy wydajności wykazały, że algorytm napisany w C\# uruchamiany natywnie jest aż do $250\times$ szybszy od tego samego algorytmu uruchomionego w interpreterze dostarczonym przez \textit{mono-wasm}. Wykres obrazujący czas wykonania kodu podczas testów w obu środowiskach został przedstawiony na rysunku~\ref{benchmark}. 
            
            \begin{figure} \centering{
                    \includegraphics[scale=0.4]{images/benchmark.png}}
                \caption{Porównanie wydajności kodu C\# uruchamianego natywnie oraz w interpretowanego w \textit{WebAssembly}}
                \label{benchmark}
            \end{figure}
        ...
        \subsection{Wieloplatformowość}
            Dowolne urządzenie wyposażone w przeglądarkę internetową obsługującą \textit{WebAssembly} może zostać węzłem obliczeniowym. W momencie tworzenia powyższego dokumentu wszystkie przeglądarki posiadające co najmniej $5\%$ udziału w rynku przeglądarek posiadają w pełni działającą implementację \textit{WebAssembly}. Podczas testów przygotowanego rozwiązania węzły obliczeniowe zostały z powodzeniem uruchomione na komputerach pracujących z systemami operacyjnymi \textit{Windows 10} oraz \textit{Ubuntu}, a także na telefonach komórkowych działających z systemami \textit{Android} oraz \textit{iOS}.
        ...
        \subsection{Bezpieczeństwo}
            ...
            Sekcja TODO szczegółowo opisuje zabezpieczenia wykorzystane w systemie, a w paragrafie TODO opisano możliwe dalsze usprawnienia polityki bezpieczeństwa tak, aby utrudnić negatywne oddziaływanie na serwer API nawet osobie mającej uprawnienia administratora.
