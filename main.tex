...
\chapter{Podsumowanie}
    ...
    W tym rozdziale opisana zostanie wykorzystana metoda wytwórcza, a także własności rozwiązania, możliwości na dalszy rozwój aplikacji,
    ...
    \section{Metoda wytwórcza}
        ...
        Później odbyła się faza testowania, gdy stworzone zostały testy jednostkowe serwera API oraz interfejsu użytkownika, a także
        testy integracyjne całego systemu (ang. \textit{\selectlanguage{english}end-to-end tests}).
        
        W trakcie całego projektu pozostawaliśmy w kontakcie z promotorem, który miał wpływ na ostateczny wygląd
        oraz zachowanie aplikacji. Miał on także nadzór nad kolejnymi etapami powstawania systemu.
        Uniknęliśmy dzięki temu problemów związanych z różnicą w interpretacji wymagań, ponieważ wszelkie wątpliwości
        były rozwiązywane w krótkim czasie.
