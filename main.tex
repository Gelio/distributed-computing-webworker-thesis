...
Celem projektu było stworzenie rozwiązania, które zapewnia łatwe wykorzystanie modułów napisanych i kompilowanych
w języku C\#. Węzły obliczeniowe uruchamiałyby program działający w technologii \textit{\selectlanguage{english}WebAssembly}
i komunikowałyby się z centralnym serwerem rozdzielającym zadania i scalającym wyniki. Dodatkowo udostępniony byłby
