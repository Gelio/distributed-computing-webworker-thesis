...
Przykładem logiki wykonywanej w opisanych serwisach jest weryfikacja, czy nazwa dodawanego zadania jest unikatowa.
...
Aby utworzyć instancję \texttt{ProblemPluginFacade} konieczne jest wykorzystanie refleksji oraz aplikowanie typów generycznych do interfejsów. Z tego powodu został wykorzystany wzorzec fabryki.
