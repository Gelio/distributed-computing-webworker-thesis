...
W tym dokumencie opisano cel projektu, przeanalizowano istniejące rozwiązania realizujące obliczenia rozproszone,
podano wymagania funkcjonalne i niefunkcjonalne systemu, przedstawiono architekturę utworzonego rozwiązania
wraz z użytymi technologiami, opisano instrukcję wdrożenia i utrzymania systemu, a na końcu przedstawiono
wyciągnięte wnioski oraz możliwości dalszego rozwoju systemu.
