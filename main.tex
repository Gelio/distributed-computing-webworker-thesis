...
\chapter{Podsumowanie}
    \section{Własności rozwiązania}
        ...
        \subsection{Wydajność}
            Wydajność \textit{C\#} uruchamianego w interpreterze w przeglądarce okazała się być niska w porównaniu do \textit{C\#} kompilowanego do programu wykonywalnego.
            Wykonane testy wydajności wykazały, że algorytm napisany w \textit{C\#} uruchamiany natywnie jest aż do $250\times$ szybszy od tego samego algorytmu uruchomionego w interpreterze dostarczonym przez \textit{mono-wasm}.
