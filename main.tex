...
\section{Podział prac}
    ...
    Podczas tworzenia projektu Przemysław Proszewski odpowiedzialny był za integrację serwera aplikacyjnego
    z bazą danych oraz \textit{mono-wasm}, a także przygotowanie formularzy po stronie panelu administracyjnego
    oraz stworzenie biblioteki C\# do implementacji algorytmów.
    
    Grzegorz Rozdzialik zajął się przygotowaniem API serwera aplikacyjnego, integracją interfejsu użytkownika z API
    oraz prezentacji danych w formacie tabelarycznym, stworzeniem panelu węzła obliczeniowego, a także
    opracowaniem konfiguracji wdrożeniowej projektu.
    
    Pisząc ten dokument Przemysław Proszewski przygotował następujące rozdziały i sekcje: Analiza problemu, Zabezpieczenia,
    Opis aplikacji, Własności rozwiązania, Możliwości na rozwój.
    
    Grzegorz Rozdzialik opisał następujące rozdziały i sekcje: Wstęp, Projekt modułów, Szczegółowy opis implementacji,
    Problemy implementacyjne, wnioski z projektu.
