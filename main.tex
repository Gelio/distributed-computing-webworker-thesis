...
\section{Podział prac}
    ...
    \begin{center}
        \begin{longtable}{| p{.30\textwidth-2\tabcolsep} | p{.70\textwidth-2\tabcolsep} |}
            ...
            Przemysław Proszewski &
            Analiza problemu, Zabezpieczenia, Opis aplikacji, Własności rozwiązania, Możliwości na rozwój. \\ \hline
            
            Grzegorz Rozdzialik &
            Wstęp, Projekt modułów, Szczegółowy opis implementacji, Problemy implementacyjne, Wnioski z projektu. \\ \hline
        \end{longtable}
    \end{center}
