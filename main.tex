...
Obliczenia rozproszone są metodą na rozwiązanie potencjalnie skomplikowanych problemów dzieląc je na mniejsze i rozwiązując każdy z nich równolegle na oddzielnych maszynach. Tradycyjnie dołączenie nowych urządzeń jako węzły sieci obliczeń rozproszonych odbywało się poprzez instalację specjalnego oprogramowania klienckiego, które komunikowało się z centralnym serwerem rozdzielającym zadania.

W ramach tej pracy inżynierskiej stworzono system umożliwiający realizację obliczeń rozproszonych z węzłami działającymi w przeglądarce internetowej. To podejście uprościło proces dołączania nowych urządzeń do sieci --- nie trzeba instalować oprogramowania węzła działającego bezpośrednio w systemie operacyjnym. Dodatkowo, dzięki takiemu rozwiązaniu można wykorzystać więcej urządzeń jako węzły obliczeniowe z uwagi na fakt, że urządzenia takie jak telewizory \textit{SmartTV} czy telefony komórkowe również mogą wykonywać zadania, o ile ich przeglądarka internetowa spełnia wymagania systemowe.

W tym dokumencie opisano cel projektu, przeanalizowano istniejące rozwiązania realizujące obliczenia rozproszone, podano wymagania funkcjonalne i niefunkcjonalne systemu, przedstawiono architekturę utworzonego rozwiązania wraz z użytymi technologiami, opisano instrukcję wdrożenia i utrzymania systemu, a na końcu przedstawiono wyciągnięte wnioski oraz możliwości dalszego rozwoju systemu.
