...
\chapter{Wstęp}
    ...
    Obliczenia równoległe pozwalają na użycie do rozwiązania pojedynczego problemu wielu jednostek obliczeniowych w celu uzyskania wyników w krótszym czasie, niż jakby dane zadanie było wykonywane w sposób sekwencyjny przez jeden procesor.
    ...
    Istnieją projekty, które można wykonywać niezależnie na wielu różnych urządzeniach i są niewrażliwe na różną wydajność maszyn na których są obliczane.
...
\begin{thebibliography}{35}%jak ktoś ma więcej książek, to niech wpisze większą liczbę
    ...
    \bibitem[40]{uchwala-prawa-autorskie} Regulamin zarządzania prawami autorskimi obowiązujący na Politechnice Warszawskiej \url{https://www.bip.pw.edu.pl/Wewnetrzne-akty-prawne/Regulaminy/Regulamin-zarzadzania-prawami-autorskimi-i-prawami-pokrewnymi-oraz-prawami-wlasnosci-przemyslowej-oraz-zasad-komercjalizacji}/
\end{thebibliography}
