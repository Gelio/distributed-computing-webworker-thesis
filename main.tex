...
\chapter{Podsumowanie}
    ...
    \section{Problemy implementacyjne}
        Poniższa sekcja opisuje problemy implementacyjne napotkane podczas wykonywania aplikacji.
        
        \paragraph{Izolacja kodu użytkownika}\mbox{}\\
        ...
        \paragraph{Korzystanie z mono-wasm}\mbox{}\\
        ...
        \paragraph{Arch Linux oraz Docker}\mbox{}\\
        ...
        \paragraph{Brakujące ciasteczka}\mbox{}\\
            ...
            Konsekwencją nieprzesyłania ciasteczek do serwera API jest brak dostępu do panelu administracyjnego. Po analizie problemu okazało się, że w przeszłości funkcja \textit{fetch} domyślnie nie wysyłała ciasteczek. W celu zadbania o kompatybilność ze starszymi przeglądarkami zdecydowaliśmy się na dodanie odpowiednich parametrów do komponentów odpowiedzialnych za komunikację sieciową.
